...
const CITY_COORDS = {
  ...
  siesta:  { lat:  27.2659, lon: -82.5460, tz: "America/New_York",               name: "Siesta Key",   emoji: "🏝️" },
};
...
const CITY_COLORS = {
  ...
  siesta: { bg: "#0A2A33", accent: "#22D3EE", label: "Siesta Key 🏝️" },
};
...
const DEFAULT_DATA = {
  ...
  itinerary: [
    ...
    { id:"d2", date:"2026-06-12", city:"nyc", title:"Miami → Nueva York — Llegada 🗽",
  activities:"06:54 - Llegada a Miami MIA · café\n09:59 - Vuelo MIA → NYC · American Airlines · $204/pax\n13:01 - Llegada a LGA/JFK · AirTrain + subway al hotel (~$8.50) o taxi (~$60)\n14:00 - Check-in DoubleTree Hilton · dejar valijas\n14:30 - Almuerzo en Hell's Kitchen · 9th Ave entre 45-55th · cocina étnica variada\n15:30 - Times Square · primera foto en el centro · TKTS para ver precios Broadway\n16:30 - 5th Avenue caminando · Rockefeller Center · St. Patrick Cathedral (gratis)\n17:15 - Grand Central Terminal · Main Concourse · Whispering Gallery (esquina NE nivel inferior)\n18:30 - Bryant Park · descanso · ambiente local\n19:30 - Cena en Koreatown (32nd St) o regreso a Times Square iluminado de noche\n21:00 - Vuelta al hotel · descansar del viaje",
  notes:"💡 Día tranquilo de llegada para aclimatarse. Comprar la OMNY semanal ilimitada (~$34/pax) en cualquier molinete del subway." },
    { id:"d3", date:"2026-06-13", city:"nyc", title:"Hudson Yards — Edge, Vessel & Circle Line 🚢",
  activities:"08:30 - Desayuno cerca del hotel\n09:30 - Edge (Hudson Yards) · el sky deck al aire libre más alto del hemisferio · piso 100 · reservar online ~$40/pax · entrada por Level 4 del mall\n10:00 - Vessel · la escultura panal de Thomas Heatherwick · sacar fotos · entrada con ticket (mínimo 2 personas juntas) · está al lado de Edge\n11:00 - The Shops at Hudson Yards · vueltita + vistas\n12:00 - Almuerzo en Hudson Yards o cerca de Pier 83\n13:15 - Caminar a Pier 83 (W 42nd & 12th Ave) · 12 min\n13:30 - Circle Line — Best of NYC Cruise · 2.5hs · da la vuelta COMPLETA a Manhattan · pasa por Estatua de la Libertad, Brooklyn Bridge, One WTC · llegar 45 min antes · ~$49/pax · reservar online\n16:15 - Fin del crucero · descanso\n17:30 - The High Line · entrar en 34th St (al lado de Hudson Yards) · caminar hacia el sur\n18:30 - Chelsea Market · Los Tacos No.1 + puestos gourmet\n20:00 - MoMA · ABRE HASTA LAS 21hs los sábados · Starry Night, Warhol, Monet · ~$30/pax · 5th Ave y 53rd\n21:00 - Cena tardía en Midtown",
  notes:"💡 Edge + Vessel + Circle Line están todos en la misma zona (Hudson Yards / Pier 83). Reservar Edge y Circle Line con anticipación online. El MoMA los sábados cierra 21hs — ideal para el final del día." },
    { id:"d4", date:"2026-06-14", city:"nyc", title:"Downtown — WTC, SoHo, Little Italy & Chinatown 🏙️",
  activities:"08:30 - Desayuno · bagel con salmón en deli\n09:15 - Subway al Financial District · línea 1/2/3\n09:30 - 9/11 Memorial · los dos estanques donde estaban las Torres Gemelas · nombres grabados · museo opcional ~$30 · memorial gratis\n10:30 - Oculus (WTC Hub) · arquitectura de Calatrava · interior blanco impresionante · gratis\n11:15 - Wall Street · Charging Bull · Fearless Girl · NYSE\n12:00 - Almuerzo en Stone Street (calle adoquinada histórica) o Fraunces Tavern\n13:30 - SoHo · subir por Broadway · arquitectura de hierro fundido · galerías · tiendas · Prince St y Spring St\n15:00 - Little Italy · Mulberry St · cannoli en Ferrara Bakery (desde 1892) · café\n15:45 - Chinatown · Canal St · Columbus Park · dim sum · el contraste cultural es brutal\n17:00 - Caminar hacia el Brooklyn Bridge\n17:30 - Cruzar el Brooklyn Bridge a pie hacia DUMBO · foto icónica desde Washington St\n19:00 - Cena en DUMBO · Juliana's Pizza · o Time Out Market Brooklyn con vista al skyline\n21:00 - Vuelta en subway",
  notes:"💡 Todo el Bajo Manhattan en un día, de norte a sur en orden lógico. El cruce del Brooklyn Bridge al atardecer es de los mejores momentos del viaje." },
    { id:"d5", date:"2026-06-15", city:"nyc", title:"Central Park + Hop-on Hop-off + Despedida 🚌",
  activities:"08:30 - Desayuno en diner de Upper West Side\n09:30 - Central Park · entrar por la zona oeste · Strawberry Fields (tributo Lennon) → Bethesda Fountain → Bow Bridge → The Mall · alquilar bici opcional\n11:30 - Salida del parque\n12:00 - Bus Hop-on Hop-off (si da el tiempo) · línea Uptown o Downtown · subirse y ver la ciudad desde arriba · ~$55/pax · ideal para cubrir lo que falte sin caminar\n13:30 - Bajar en la zona que quieran · almuerzo\n15:00 - Compras finales · 5th Ave · Apple Store · Macy's en Herald Square\n16:30 - Top of the Rock o Empire State (si quieren una última vista panorámica) · opcional\n18:00 - Vuelta al hotel · armar valijas\n19:30 - Cena de despedida de NYC · elegir un lugar especial\n21:30 - Preparar todo · vuelo mañana 7:30am (Delta)",
  notes:"⚠️ Vuelo mañana 7:30am desde LGA — Uber a las 5:45am MÁXIMO. Dejar las valijas listas esta noche. El Hop-on Hop-off es flexible: si vienen cansados, lo saltean y disfrutan Central Park con calma." },
    { id: "d6", date: "2026-06-16", title: "Kansas City ⚽ PARTIDO 1 🇦🇷", city: "kc", activities: "05:45 - Uber al aeropuerto\n07:30 - Vuelo NYC → Kansas City (Delta)\n11:05 - Llegada · retirar auto Hertz\n20:00 - ⚽ ARGENTINA 🇦🇷 vs ARGELIA 🇩🇿 · Partido 1 del Mundial", notes: "🏟️ Primer partido. Llegar al estadio a las 18hs. ⚠️ Vuelo Delta 7:30am — Uber a las 5:45am." },
    ...
    { id:"d15", date:"2026-06-25", city:"siesta", title:"Orlando → Siesta Key 🏝️",
  activities:"Mañana: check-out de Orlando · desayuno\nDevolver el auto de Orlando o seguir viaje (revisar reserva)\n~2h45 de viaje Orlando → Siesta Key (≈260 km por I-4 y I-75)\nCheck-in en el Airbnb de Siesta Key\nTarde: primera ida a Siesta Beach · arena blanca de cuarzo (de las más finas del mundo)\nAtardecer en la playa · Siesta Key es famoso por sus puestas de sol\nNoche: cena en Siesta Key Village · ambiente relajado",
  notes:"🏝️ Siesta Key tiene la arena más blanca y fina de EE.UU. — no se calienta aunque haya 35°C. Llegada para relajarse después de 2 semanas a full." },
    { id:"d16", date:"2026-06-26", city:"siesta", title:"Siesta Key — Playa y relax 🏖️",
  activities:"Mañana tranquila · desayuno sin apuro\nSiesta Beach · sombrilla, reposeras, mar cálido del Golfo\nMediodía: almuerzo frente al mar\nTarde: caminar por Crescent Beach (más tranquila) o Point of Rocks (snorkel)\nOpcional: alquilar kayak o paddleboard\nAtardecer: Siesta Key Drum Circle en la playa (domingos, si coincide) · músicos al atardecer\nCena en Siesta Key Village · The Hub o Daiquiri Deck",
  notes:"🥁 El Drum Circle de Siesta Key es una tradición: músicos y gente bailando en la playa al atardecer. Point of Rocks es el mejor lugar para snorkel." },
    { id:"d17", date:"2026-06-27", city:"siesta", title:"Siesta Key — Último día 🌅",
  activities:"Último día de playa · relax total\nMañana: nado y sol en Siesta Beach\nOpcional: excursión a Lido Key o paseo a Sarasota (St. Armands Circle · tiendas y restaurantes)\nTarde: compras de souvenirs en Siesta Key Village\nArmar valijas\nCena de despedida del viaje · elegir el mejor lugar frente al mar\nÚltima puesta de sol del viaje en la playa",
  notes:"🌅 Aprovechen la última puesta de sol. Mañana arranca la vuelta a casa desde Miami — revisar el traslado Siesta Key → Miami (≈3h30 de viaje)." },
    { id:"d18", date:"2026-06-28", city:"bsas", title:"Siesta Key → Miami → Buenos Aires ✈️🇦🇷",
  activities:"Mañana temprano: check-out del Airbnb de Siesta Key\nTraslado Siesta Key → Aeropuerto de Miami (MIA) · ≈3h30 de viaje (≈340 km)\nSalir con tiempo de sobra para el vuelo internacional\n15:35 - Vuelo MIA → LIM (LATAM) · Asientos 20D · 21E\n02:00 (+1) - Vuelo LIM → AEP (American Airlines) · Asientos 18 D·E·F",
  notes:"⚠️ Siesta Key → Miami son ≈3h30 de auto. Salir bien temprano para llegar al MIA al menos 3hs antes del vuelo internacional (15:35). Llegada a Buenos Aires 08:30 del 29/6. ¡Fin del viaje!" },
  ],
